...
const MiniChart = ({ color = 'var(--primary)', delay = 0 }) => (
  <div
    style={{ height: '35px', width: '100%', marginTop: '12px', opacity: 0.8 }}
  >
    <svg
      viewBox="0 0 100 30"
...
const LandingPage = ({
  ...
  connect: () => void;
  setView: (v: 'employer' | 'employee') => void;
}) => (
  <div className="landing-container animate-fade-in">
    <nav className="landing-nav">
      ...
      <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
        ...
        <button className="btn-connect-pro" onClick={connect}>
          Launch App
        </button>
      </div>
    </nav>
    ...
    <section className="landing-hero-grid">
      ...
      <div className="hero-text-side">
        ...
        <p className="landing-subtitle">
          GhostPay is the leading confidential payroll protocol on Arbitrum
          Sepolia. Execute bulk distributions and manage global teams with
          end-to-end encryption powered by iExec Nox confidential computing.
        </p>
        <div style={{ display: 'flex', gap: '1.5rem', marginTop: '1rem' }}>
          <button className="launch-btn-giant" onClick={connect}>
      ...
      <div className="hero-visual-side">
        ...
        <img
          src="/ghostpay_3d_vault.png"
          className="floating-asset"
          alt="Confidential Vault"
        />
      </div>
    </section>
    ...
    <section className="landing-features" id="features">
      <div className="landing-card">
        ...
        <p>
          Your payroll data is stored in secure, encrypted enclaves. Neither
          GhostPay nor the network can see your distribution amounts.
        </p>
      </div>
      <div className="landing-card">
        <div className="feature-icon-box">
        ...
        <h3>Bulk Batching</h3>
        <p>
          Distribute salaries to your entire global team in a single
          confidential batch. Low gas, maximum privacy, zero delay.
        </p>
      </div>
      <div className="landing-card">
        <div className="feature-icon-box">
        ...
        <p>
          Employees claim their earnings via secure confidential transfers,
          ensuring total privacy for individual salary data.
        </p>
      </div>
    </section>
    ...
    <section className="landing-info-section">
      <div className="info-header">
        ...
        <p>
          A three-step confidential bridge between corporate treasury and
          employee wallets.
        </p>
      </div>
      <div className="workflow-grid">
        <div className="workflow-step">
          ...
          <div className="step-icon">
            <LockKey size={32} color="var(--primary)" />
          </div>
          <h4>Deposit & Wrap</h4>
          <p>
            Employers deposit standard USDC into the GhostPay vault. iExec Nox
            wraps it into confidential cUSDC, hiding the balance from public
            view.
          </p>
        </div>
        ...
        <div className="workflow-step">
          ...
          <div className="step-icon">
            <PaperPlaneTilt size={32} color="var(--primary)" />
          </div>
          <h4>Batch Dispatch</h4>
          <p>
            Execute bulk payroll to thousands of addresses. On-chain observers
            only see a single batch transaction with encrypted individual
            amounts.
          </p>
        </div>
        <ArrowRight size={24} className="step-arrow" />
        <div className="workflow-step">
          ...
          <div className="step-icon">
            <HandCoins size={32} color="var(--primary)" />
          </div>
          <h4>Private Claim</h4>
          <p>
            Employees connect their wallets and claim their specific salary. The
            transaction history is obscured via Nox, preserving income privacy.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="ecosystem-card employer">
        ...
        <ul className="feature-list">
          <li>
            ...
            <span>
              <strong>Bulk CSV Engine:</strong> Paste or upload thousands of
              employee records instantly.
            </span>
          </li>
          <li>
            <CheckCircle size={20} weight="fill" color="var(--primary)" />
            <span>
              <strong>AI Analytics:</strong> ChainGPT powered insights into
              payroll volume and burn rates.
            </span>
          </li>
          <li>
            <CheckCircle size={20} weight="fill" color="var(--primary)" />
            <span>
              <strong>Shadow Mode:</strong> Toggle UI privacy for secure screen
          ...
          <li>
            <CheckCircle size={20} weight="fill" color="var(--primary)" />
            <span>
              <strong>Multi-Asset Vaults:</strong> Support for any ERC-20
              confidential wrapping.
            </span>
          </li>
        </ul>
      </div>
      <div className="ecosystem-card employee">
        ...
        <ul className="feature-list">
          <li>
            ...
            <span>
              <strong>Confidential Balance:</strong> Your income is your
              business. Balances are hidden from Etherscan.
            </span>
          </li>
          <li>
            <CheckCircle size={20} weight="fill" color="var(--success)" />
            <span>
              <strong>GhostAssistant AI:</strong> Query your specific payout
              history via a secure AI interface.
            </span>
          </li>
          <li>
            <CheckCircle size={20} weight="fill" color="var(--success)" />
            <span>
              <strong>One-Click Claims:</strong> Withdraw your earnings to your
              wallet in seconds.
            </span>
          </li>
          <li>
            <CheckCircle size={20} weight="fill" color="var(--success)" />
            <span>
              <strong>Identity Verification:</strong> ZK-proof based session
              management for profile access.
            </span>
          </li>
        </ul>
      </div>
    ...
    <section className="landing-cta-final">
      ...
      <p>
        Join the future of confidential institutional finance on Arbitrum
        Sepolia.
      </p>
      <button
        className="launch-btn-giant"
        onClick={connect}
    ...
    <footer className="landing-footer">
      <div className="footer-content">
        <div className="footer-brand">
          ...
          />
          <p>
            Institutional-grade confidential payroll infrastructure on Arbitrum
            Sepolia.
          </p>
        ...
        <div className="footer-links-grid">
          <div className="footer-col">
            ...
            <a
              href="https://docs.iex.ec/nox-protocol/welcome"
              target="_blank"
              rel="noreferrer"
            >
              Security
          ...
          <div className="footer-col">
            ...
            <a
              href="https://github.com/Lumixx09/GhostPay"
              target="_blank"
              rel="noreferrer"
            >
              Github
          ...
          <div className="footer-col">
            <h4>Social</h4>
            <a href="https://x.com/iex_ec" target="_blank" rel="noreferrer">
              Twitter / X
            </a>
            <a
              href="https://discord.gg/RXYHBJceMe"
      ...
      <div className="footer-bottom">
        <p>
          &copy; 2026 GhostPay Protocol. Built for the iExec Vibe Coding
          Challenge.
        </p>
        <div style={{ display: 'flex', gap: '2rem' }}>
          <a
            href="https://iex.ec/privacy-policy/"
            target="_blank"
            rel="noreferrer"
          >
            Privacy Policy
          ...
          <a
            href="https://iex.ec/terms-and-conditions/"
            target="_blank"
            rel="noreferrer"
          >
            Terms of Service
...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<
    'dashboard' | 'payrolls' | 'history' | 'contacts' | 'profile' | 'settings'
  >('dashboard');
  ...
  const [activeModal, setActiveModal] = useState<null | 'contact' | 'wrap'>(
    null,
  );
  ...
  const handleVerifyIdentity = async () => {
    ...
    const success = await verifyIdentity(
      'Verify cryptographic identity to access GhostPay Confidential Settings.',
    );
    if (success) {
  ...
  const handleBulkDistribute = async () => {
    ...
    try {
      ...
      if (addresses.length === 0)
        throw new Error('No valid recipients found. Use: address amount');
      await distributePayroll(addresses, amounts);
      showNotification(
        `Successfully distributed payroll to ${addresses.length} employees!`,
      );
      setBulkInput('');
    } catch (error: any) {
      console.error(error);
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          >
            <PaperPlaneTilt
              size={26}
              weight={activeTab === 'payrolls' ? 'fill' : 'regular'}
            />
          </div>
          <div
          ...
          >
            <Users
              size={26}
              weight={activeTab === 'contacts' ? 'fill' : 'regular'}
            />
          </div>
          <div
      ...
      <main className="main-wrapper">
        <div className="main-header-row">
          <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
            ...
            <button
              className={`stealth-toggle ${isShadowMode ? 'active' : ''}`}
          ...
          {!isConnected && activeTab !== 'dashboard' ? (
            <div className="locked-segment-container animate-fade-in">
              ...
              <p style={{ color: 'var(--text-dim)', maxWidth: '450px' }}>
                You have successfully signed out of the protocol. Please
                reconnect your wallet to interact with your confidential vault.
              </p>
              <button
            ...
            view === 'employer' ? (
              <div className="cards-layout animate-fade-in">
                  ...
                  >
                    ...
                    >
                      {history
                        .reduce(
                          (acc, tx) =>
                            acc + (tx.type === 'payroll' ? tx.count || 0 : 0),
                          0,
                        )
                        .toLocaleString()}
                    </div>
                ...
                <div
                  className="pro-card"
                  style={{ gridColumn: 'span 3', padding: '2.5rem' }}
                >
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    ...
                    <div className="ai-status-pill" style={{ margin: 0 }}>
                      Synced: {history.length} Events
                    </div>
                  </div>
                  <div
                    style={{
                            ...
                            <div>
                              <div style={{ fontWeight: 700 }}>
                                {isShadowMode ? (
                                  ...
                                  `Confidential Batch #${tx.hash.slice(2, 6).toUpperCase()}`
                                ) : (
                                  'Salary Claim'
                                )}
                              </div>
              ...
              >
                <span className="ai-status-pill">
                  <ShieldCheck size={14} weight="bold" /> Nox Protocol Active
                </span>
                <div className="section-meta" style={{ marginTop: '1.5rem' }}>
            ...
            <div
              className="pro-card"
              style={{ gridColumn: 'span 3', padding: '3rem' }}
            >
              <div
                style={{
                  display: 'flex',
              ...
              >
                <div>
                  <h2 style={{ fontSize: '1.8rem' }}>
                    Bulk Confidential Payroll
                  </h2>
                  <p style={{ color: 'var(--text-dim)', marginTop: '0.5rem' }}>
                    Enter addresses and amounts to distribute privately via Nox.
                  </p>
                </div>
              ...
              <div className="bulk-input-container">
                ...
                <div className="input-hint">
                  Format: [Wallet Address], [Amount in USDC] per line
                </div>
              </div>
              <button
                className="btn-connect-pro"
              ...
              >
                {isProcessing || isPending ? (
                  ...
                  <>
                    <PaperPlaneTilt size={24} weight="bold" /> Execute
                    Confidential Payout
                  </>
                )}
              </button>
            ...
            >
              ...
              >
                <div>
                  <h2>Confidential Contacts</h2>
                  <p style={{ color: 'var(--text-dim)' }}>
                    Your private enterprise address book. Stored in local vault.
                  </p>
                </div>
                <div style={{ display: 'flex', gap: '1rem' }}>
                  {selectedContacts.length > 0 && (
                    <button
                      ...
                      onClick={() => {
                        const formatted = selectedContacts
                          .map((addr) => `${addr}, 1000`)
                          .join('\n');
                    ...
                    >
                      <PaperPlaneTilt size={20} weight="bold" /> Dispatch to{' '}
                  ...
                  >
                    <Plus size={20} weight="bold" /> Add Contact
                  </button>
                </div>
              </div>
              <div
              ...
              >
                {contacts.length > 0 ? (
                  contacts.map((contact, i) => (
                    <div
                      key={i}
                      className={`pro-card ${selectedContacts.includes(contact.address) ? 'selected-contact' : ''}`}
                      style={{
                        padding: '1.5rem',
                        background: 'rgba(255,255,255,0.01)',
                        border: selectedContacts.includes(contact.address)
                        ...
                        <div style={{ display: 'flex', gap: '10px' }}>
                          <button
                            style={{
                              background: 'transparent',
                              border: 'none',
                              color: selectedContacts.includes(contact.address)
                                ? 'var(--primary)'
                                : 'var(--text-dim)',
                              fontSize: '0.75rem',
                              fontWeight: 700,
                          ...
                          >
                            {selectedContacts.includes(contact.address)
                              ? 'Deselect'
                              : 'Select'}
                          </button>
                          <button
            ...
            >
              ...
              >
                ...
                <div className="ai-status-pill">Arbiscan Verified</div>
              </div>
              <div
                style={{
                  display: 'flex',
            ...
            >
              <img
                src={`https://api.dicebear.com/7.x/identicon/svg?seed=${account || 'ghost'}`}
                style={{
                  width: '180px',
                  borderRadius: '40px',
              ...
              <div>
                ...
                <h2 style={{ fontSize: '2.5rem', wordBreak: 'break-all' }}>
                  {account || 'Disconnected'}
                </h2>
                <p style={{ color: 'var(--text-dim)', marginBottom: '1.5rem' }}>
                  Protected by iExec Nox Infrastructure.
                </p>
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <button
                    className="btn-connect-pro"
            ...
            !isSettingsUnlocked ? (
              <div className="locked-segment-container animate-fade-in">
                ...
                <p style={{ color: 'var(--text-dim)', maxWidth: '450px' }}>
                  This area contains sensitive protocol configurations. Please
                  verify your cryptographic identity to proceed.
                </p>
                <button
              ...
              <div className="settings-grid">
                <div className="settings-card" style={{ gridColumn: 'span 2' }}>
                  ...
                  >
                    <ShieldCheck size={14} weight="bold" /> Identity
                    cryptographically verified via Nox session.
                  </div>
                </div>
                ...
                <div className="settings-card">
                  <div className="settings-label">
                    <CircleNotch size={18} weight="bold" /> AI Analytics Engine
                  </div>
                ...
                >
                  ...
                  >
                    <ShieldCheck size={18} weight="bold" /> Network Status
                  </div>
                  <div
                    style={{
                      display: 'flex',
      ...
      <aside className="right-panel">
        <section>
          <h2 className="panel-section-title">
            <TrendUp size={22} weight="bold" /> Stats
          </h2>
          <div className="ai-brief-card">
            <span className="ai-status-pill">Health: ONLINE</span>
            <p>Connected to Arbitrum Sepolia via Nox Vault.</p>
          </div>
        </section>
        <section className="chat-compact">
          <h2 className="panel-section-title">Transaction Audit AI</h2>
          <ChatAssistant history={history} view={view} />
        </section>
      </aside>
        ...
        <div className="modal-overlay" onClick={() => setActiveModal(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-subtitle">
              {activeModal === 'contact'
                ? 'Add a recipient to your confidential vault.'
                : 'Wrap public USDC into confidential cUSDC.'}
            </div>

            <div className="modal-input-group">
              <label className="modal-label">
                {activeModal === 'contact' ? 'Contact Name' : 'Deposit Amount'}
              </label>
              <input
                type="text"
                ...
                onChange={(e) =>
                  setModalData({ ...modalData, field1: e.target.value })
                }
                autoFocus
              />
            </div>
            ...
            {activeModal === 'contact' && (
              <div className="modal-input-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModalData({ ...modalData, field2: e.target.value })
                  }
                />
              </div>
            )}
            ...
            <div className="modal-actions">
              ...
              <button
                ...
                disabled={
                  !modalData.field1 ||
                  (activeModal === 'contact' && !modalData.field2) ||
                  isPending
                }
                onClick={async () => {
                  if (activeModal === 'contact') {
                    setContacts([
                      ...contacts,
                      { name: modalData.field1, address: modalData.field2 },
                    ]);
